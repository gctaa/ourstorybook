...
from storyviewer.views import StoryCreationView, ChapterCreationView
...
urlpatterns = patterns('',
    ...
    url(r'^create_chapter/(?P<pk>\d+)/$', ChapterCreationView.as_view(template_name='storyviewer/chapter_create.html')),
    url(r'^login/$', login),
